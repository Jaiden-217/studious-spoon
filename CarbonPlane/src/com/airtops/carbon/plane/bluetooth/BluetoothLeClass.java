...
package com.airtops.carbon.plane.bluetooth;
...
public class BluetoothLeClass{
    private final static String TAG = DataValue.TAG;
    ...
    public void setmOnReadRssiListener(OnReadRssiListener l){
        mOnReadRssiListener = l;
    }
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {
            mOnReadRssiListener.onReadRssi(gatt, rssi);
        }
